...
STATIONEERS_STARTUP_COMMAND=$(echo "-file start $STATIONEERS_SERVER_WORLD_NAME $SERVER_WORLD_ID $SERVER_DIFFICULTY $SERVER_START_CONDITION $SERVER_START_LOCATION" | tr -s " ")
